          ...
          <div class="col-lg-8 d-block">
            <div class="row d-flex">
              ...
              <!--div class="col-lg-3 text-right"-->
                    <a href="student/login.php" class="small mr-3"><span class="icon-unlock-alt"></span> Log In</a>
                    <a href="student/register.php" class="small btn btn-primary px-4 py-2 rounded-0"><span class="icon-users"></span> Register</a>
                  </div>
      ...
      <div class="container">
		...
		<section class="ftco-section ftco-no-pt ftc-no-pb">
			<div class="container">
          	...
          	<h2 class="mb-4">CA - Chartered Accountants</h2>
            <p>Members of the Institute of Chartered Accountants of Sri Lanka (CA Sri Lanka) are known as a brand of unique and versatile professionals, with the ability to steer any business successfully. CA Sri Lanka has 6,000 members, based locally and globally and are known for their professional integrity, exceptional technical and perceptive skills, as well as financial discipline and out of the box thinking, which helps them add value to the organisations they serve for</p>

            <p>The portfolio of CA Sri Lanka members comprise of Chairmen, Partners, Managing Directors, Vice Presidents, CEOs and CFOs, among other high profile designations, who serve across top corporates in Sri Lanka and outside Sri Lanka.</p>

            <p>In its capacity as the National Professional Accountancy Organization in the country, CA Sri Lanka continuously focuses on enhancing the professional skills of its members, in ensuring that they continue to play a significant role in partnering businesses and thereby contribute to the success of the profession as well as the public and private sectors, and strengthen the national economy of Sri Lanka.</p>
					</div>
				</div>
			</div>
		</section>
    	...
    	<div class="container">
          ...
          <div class="col-md-6 heading-section heading-section-white ftco-animate pl-lg-5 pt-md-0 pt-5">
            <h2 class="mb-4">Charted Accountancy</h2>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-5">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">203 Temple RD, Matara, Sri Lanka</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">041 2234800</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">Charted@email.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
