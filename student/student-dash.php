								...
								<div class="graph cl">
									<nav>
										<ul>
											...
											<li><a href="#section-3" class="icon-food"><i class="" aria-hidden="true"></i> <span class="btn-txt">Notice</span></a></li>
											...
											<li><a href="#section-6" class="icon-truck"> <span class="btn-txt">Result</span></a></li>
											<li><a href="#section-7" class="icon-truck"> <span class="btn-txt">lec note</span></a></li>
										</ul>
									</nav>
