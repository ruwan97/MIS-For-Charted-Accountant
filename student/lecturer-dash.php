								...
								<div class="graph">
									<nav>
										<ul>
											...
											<li><a href="#section-5" class="icon-lab"><i class=""></i> <span class="btn-txt">Add Notice</span></a></li>
											<li><a href="#section-6" class="icon-truck"> <span class="btn-txt">Add Marks</span></a></li>
											<li><a href="#section-7" class="icon-truck"> <span class="btn-txt">Up Lec Notes</span></a></li>
										</ul>
									</nav>
